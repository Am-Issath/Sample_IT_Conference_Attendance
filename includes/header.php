<?php 
  //This includes the session file, this file contains code that start/resumes the session.
  //By having is in the header file, it will be included on every page, allowing session
